...
export const NAV: NavItem[] = [
  { href: "/dashboard", label: "Dashboard", group: "Overview", roles: ["HO_ADMIN", "BRANCH_ADMIN", "ONB_LEAD", "CONSIGNMENT_USER", "OB_EXEC", "PROJECT_USER", "CONCIERGE_MANAGER", "SCREEN_MANAGER"] },
